...
return [
    ...
    */
    ...
    'custom' => [
        'email' => [
            'email_validation' => 'هذا الايميل مستخدم من قبل.',
        ],
        'phone_number' => [
            'phone_validation' => 'هذا الرقم مستخدم من قبل.',
        ],
        'worker' => [
            'categories' => 'يرجى ادخال نوع عملك.',
        ],
        'application' => [
            'accept' => 'تم الموافقة على الطلب.',
            'offer' => 'يرجى ادخال العرض اولا.',
        ],
        'offer'=>[
            'refuse_reason'=>'يرجى ادخال سبب الربط.'
        ],
        'device' => [
            'delete_token' => 'تم حذف token.',
            'token_does_not_exist' => 'هذا التوكن غير موجود.',
        ],
        'general' => [
